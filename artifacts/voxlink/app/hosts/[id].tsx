...
const styles = StyleSheet.create({
  ...
  hostName: { fontSize: 24, fontFamily: "Inter_700Bold", marginTop: 8 },
  hostCountry: { fontSize: 14, fontFamily: "Inter_400Regular" },
  ...
  topBadgeText: { fontSize: 12, fontFamily: "Inter_600SemiBold" },
