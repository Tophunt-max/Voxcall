...
const styles = StyleSheet.create({
  ...
  incomingLabel: { color: "rgba(255,255,255,0.6)", fontSize: 14, fontFamily: "Inter_400Regular" },
  ...
  callerName: { color: "#fff", fontSize: 28, fontFamily: "Inter_700Bold", marginTop: 12 },
  callerRole: { color: "rgba(255,255,255,0.6)", fontSize: 14, fontFamily: "Inter_400Regular" },
  ...
  actionLabel: { color: "rgba(255,255,255,0.7)", fontSize: 13, fontFamily: "Inter_400Regular" },
});
