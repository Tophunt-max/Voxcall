...
const styles = StyleSheet.create({
  ...
  statusText: { color: "rgba(255,255,255,0.8)", fontSize: 16, fontFamily: "Inter_400Regular" },
  overlay: { ...StyleSheet.absoluteFillObject, justifyContent: "space-between", paddingHorizontal: 20 },
  topInfo: { alignItems: "center", gap: 4 },
  callerName: { color: "#fff", fontSize: 22, fontFamily: "Inter_700Bold" },
  timer: { color: "rgba(255,255,255,0.8)", fontSize: 15, fontFamily: "Inter_400Regular" },
