...
const styles = StyleSheet.create({
  ...
  hostName: { fontSize: 14, fontFamily: "Inter_400Regular" },
  ...
  ratingPrompt: { fontSize: 15, fontFamily: "Inter_500Medium" },
  rateBtn: { width: "100%", paddingVertical: 12, borderRadius: 12, alignItems: "center" },
  rateBtnText: { fontSize: 15, fontFamily: "Inter_600SemiBold" },
  thankYou: { alignItems: "center", gap: 8 },
  thankYouText: { fontSize: 15, fontFamily: "Inter_500Medium" },
