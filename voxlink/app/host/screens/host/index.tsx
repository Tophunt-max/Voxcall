    ...
    >
      ...
      <View style={[styles.header, { paddingTop: topPad + 12 }]}>
        ...
        <View style={styles.headerRight}>
          ...
          <TouchableOpacity onPress={() => router.push("/shared/notifications")} style={[styles.bellBtn, { backgroundColor: colors.surface }]}>
      ...
      <TouchableOpacity
        ...
        onPress={() => { switchRole("user"); router.replace("/user/screens/user"); }}
        activeOpacity={0.8}
      >
