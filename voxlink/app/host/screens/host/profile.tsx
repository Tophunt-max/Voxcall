  ...
  return (
    ...
    >
      <View style={[styles.header, { paddingTop: topPad + 12 }]}>
        ...
        <TouchableOpacity onPress={() => router.push("/user/profile/edit")} style={[styles.editBtn, { backgroundColor: colors.surface }]}>
      ...
      <View style={[styles.section, { backgroundColor: colors.card }]}>
        ...
        {[
          { icon: require("@/assets/icons/ic_edit.png"), label: "Edit Profile", onPress: () => router.push("/user/profile/edit") },
          { icon: require("@/assets/icons/ic_settings.png"), label: "Settings", onPress: () => router.push("/host/host/settings") },
          { icon: require("@/assets/icons/ic_language.png"), label: "Language", value: "English", onPress: () => router.push("/shared/language") },
        ].map((m, i) => (
      ...
      <View style={[styles.section, { backgroundColor: colors.card }]}>
        ...
        <TouchableOpacity style={[styles.menuItem, { borderBottomColor: colors.border }]} onPress={() => router.push("/shared/help-center")} activeOpacity={0.75}>
          <View style={[styles.menuIcon, { backgroundColor: colors.surface }]}>
        ...
        <TouchableOpacity style={[styles.menuItem, { borderBottomColor: colors.border }]} onPress={() => { switchRole("user"); router.replace("/user/screens/home"); }} activeOpacity={0.75}>
          <View style={[styles.menuIcon, { backgroundColor: colors.surface }]}>
