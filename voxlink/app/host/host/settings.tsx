  ...
  return (
    <View style={{ flex: 1, backgroundColor: colors.background }}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 40 }}>
        ...
        <View style={[styles.card, { backgroundColor: colors.card }]}>
          <Row icon="edit-2" label="Edit Host Profile" onPress={() => router.push("/user/profile/edit")} />
          <Row icon="globe" label="Languages" value="English, Hindi" onPress={() => router.push("/shared/language")} />
          <Row icon="help-circle" label="Help & Support" onPress={() => router.push("/shared/help-center")} />
          <Row icon="shield" label="Privacy Policy" onPress={() => router.push("/shared/privacy")} />
          <Row icon="info" label="About VoxLink" onPress={() => router.push("/shared/about")} />
        </View>
