...
// Uses SocketContext connection state + a fallback AppState/fetch ping as proxy for network.
// Shows a prominent banner after 5s of disconnection to inform the user.
