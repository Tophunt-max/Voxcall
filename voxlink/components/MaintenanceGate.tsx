...
// maintenance on/off propagates to live clients within ~1 min (matches the
// server's 60s cache on the endpoint).
//
      ...
      <View style={styles.content}>
        <View style={styles.iconCircle}>
          <Image
            ...
            style={{ width: 40, height: 40, tintColor: "#FFD166" }}
            resizeMode="contain"
          />
        </View>
...
const styles = StyleSheet.create({
  overlay: {
    ...
    // Keep above all sibling screens / toasts.
    zIndex: 9999,
