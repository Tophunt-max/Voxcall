...
export class WebRTCService {
  ...
  private waitForIceGathering(): Promise<void> {
    return new Promise((resolve) => {
      ...
      // Once a TURN relay candidate is gathered we have what UDP-blocked
      // networks need; give a short grace for any additional candidates then
      // resolve without waiting out the full hard cap.
