...
ALTER TABLE call_sessions ADD COLUMN IF NOT EXISTS cf_caller_track_names TEXT;
ALTER TABLE call_sessions ADD COLUMN IF NOT EXISTS cf_host_track_names TEXT;
