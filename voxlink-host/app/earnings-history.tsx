...
const TABS = ["All", "Earned", "Withdrawn", "Bonus"] as const;
type Tab = typeof TABS[number];

function filterByTab(txs: Transaction[], tab: Tab): Transaction[] {
  if (tab === "All")       return txs;
  if (tab === "Earned")    return txs.filter(t => t.type === "earn" || t.type === "purchase");
  if (tab === "Withdrawn") return txs.filter(t => t.type === "withdrawal" || t.type === "spend");
    ...
    return (
      <View style={[styles.item, { backgroundColor: colors.card, borderBottomColor: colors.border }]}>
        ...
        <View style={styles.amountCol}>
          ...
          <Text style={[styles.amountText, { color: item.amount > 0 ? "#0BAF23" : "#F44336" }]}>
...
const styles = StyleSheet.create({
  ...
  amountCol: { alignItems: "center", gap: 3 },
  coinIcon: { width: 18, height: 18 },
  amountText: { fontSize: 14, fontFamily: "Poppins_700Bold" },
