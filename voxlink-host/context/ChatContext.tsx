...
export function ChatProvider({ children }: { children: React.ReactNode }) {
  ...
  return (
    <ChatContext.Provider value={{ conversations, sendMessage, editMessage, deleteMessage, markRead, loadConversations, loadMessages, getOrCreateConversation, sendTyping, setActiveRoom, totalUnread }}>
      {children}
