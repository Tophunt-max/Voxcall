...
/**
 * Blocking ban popup for the host app. Full-screen, NON-DISMISSABLE — the host
 * cannot close it or use any other part of the app until the ban is lifted or
 * expires. No logout; the popup simply persists.
 */
