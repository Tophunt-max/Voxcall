// ============================================================================
// Cross-platform dialogs — themed popups app-wide (host app).
// ============================================================================
//
...
// every confirmation/alert across the host app looks consistent on web AND
// native, replacing the OS default Alert.alert.
//
